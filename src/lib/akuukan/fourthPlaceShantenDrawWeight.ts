...
export interface AkuukanPlayerSkill4_8DrawWeightInput {
...
export function getAkuukanPlayerSkill4_8DrawWeightMultiplier(
  input: AkuukanPlayerSkill4_8DrawWeightInput
): number {
  if (
