...
export interface AkuukanPlayerSkill4_5DrawWeightInput {
...
export function getAkuukanPlayerSkill4_5DrawWeightMultiplier(
  input: AkuukanPlayerSkill4_5DrawWeightInput
): number {
  if (
