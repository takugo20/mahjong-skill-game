...
interface PlayerSkill4_19PanelProps {
  tiles: readonly Tile[];
...
export function PlayerSkill4_19Panel({
  tiles,
  selectableTileIds,
  selectedTileIds,
  maximumCount,
  ...
  onConfirm,
  onCancel
}: PlayerSkill4_19PanelProps) {
  const candidates = tiles.filter(
    (tile) =>
      (tile.suit === "man" || tile.suit === "sou") &&
  ...
  return (
    <section aria-label="手牌整理【筒】の交換牌選択">
      <p role="status">
        手牌整理【筒】：交換する萬子・索子を選択
